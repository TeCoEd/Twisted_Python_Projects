...
def close_app():
    app.info("Timer", "See you again")
    app.destroy()
    sys.exit()    
    
# App

app = App("Countdown Timer", height = 650)
app.bg =" #EBECF0" 
title_label = Text(app, size = 25, text = "COUNTDOWN TIMER")

instruct1 = Text(app, "1: Use the sliders to select hours, minutes and seconds")
instruct2 = Text(app, "2: Press the ORANGE submit button when ready")
instruct3 = Text(app, "3: Press the GREEN button to begin the countdown")
instruct4 = Text(app, "")
...
exit_button = PushButton(app, command = close_app, text="Close Timer") 
